...
SCRIPT_PATH = PROJECT_ROOT / "blender" / "scripts" / "gerar_faca_butter_knife_0601_0800_v3.py"
BLEND_PATH = PROJECT_ROOT / "blender" / "cenas" / "faca" / "faca_butter_knife_0601_0800_v3.blend"
...
WOOD_COLORS = [
    ((0.075, 0.027, 0.007, 1.0), (0.175, 0.075, 0.022, 1.0)),
    ((0.095, 0.036, 0.010, 1.0), (0.210, 0.095, 0.030, 1.0)),
    ((0.065, 0.022, 0.005, 1.0), (0.155, 0.062, 0.018, 1.0)),
    ((0.110, 0.043, 0.012, 1.0), (0.235, 0.105, 0.034, 1.0)),
]
...
def create_background_material():
    ...
    principled.inputs["Base Color"].default_value = (0.022, 0.025, 0.032, 1.0)
...
def configure_render():
    ...
    background.inputs["Color"].default_value = (0.018, 0.021, 0.026, 1.0)
...
def randomize_scene(refs):
    ...
    refs["key"].data.energy = random.uniform(175, 230)
    ...
    refs["fill"].data.energy = random.uniform(58, 92)
    ...
    refs["top"].data.energy = random.uniform(105, 145)
    ...
    refs["rim"].data.energy = random.uniform(15, 28)
