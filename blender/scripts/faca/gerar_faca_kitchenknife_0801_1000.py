...
SCRIPT_PATH = PROJECT_ROOT / "blender" / "scripts" / "gerar_faca_kitchenknife_0801_1000.py"
BLEND_PATH = PROJECT_ROOT / "blender" / "cenas" / "faca" / "faca_kitchenknife_0801_1000.blend"
...
def configure_render():
    ...
    if scene.world is None:
        scene.world = bpy.data.worlds.new("World_KitchenKnife_0801_1000")
...
def import_model():
    ...
    for obj in list(imported):
        if obj != knife and obj.name in bpy.data.objects and obj.type != "MESH":
...
def generate_one(index, refs, model):
    ...
    for attempt in range(1, MAX_ATTEMPTS + 1):
        ...
        bbox = fit_camera_and_get_bbox(scene, camera, model["object"])
