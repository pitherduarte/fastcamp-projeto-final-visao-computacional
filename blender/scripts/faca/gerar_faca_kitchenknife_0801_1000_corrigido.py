...
SCRIPT_PATH = PROJECT_ROOT / "blender" / "scripts" / "gerar_faca_kitchenknife_0801_1000_corrigido.py"
BLEND_PATH = PROJECT_ROOT / "blender" / "cenas" / "faca" / "faca_kitchenknife_0801_1000_corrigido.blend"
...
def randomize_scene(refs):
    ...
    refs["fill"].data.energy = random.uniform(18, 36)
    ...
    refs["rim"].data.energy = random.uniform(4, 10)
